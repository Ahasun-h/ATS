                      ...
                      <tbody>
                       @foreach($country as $key => $countrys)
                         <tr>
                           ...
                           <td>{{$countrys->name}}</td>
                           <td>
                            <a onclick="return confirm('Are you sure To Confirm This')" title="Print" class="btn btn-danger waves-effect waves-float waves-light" href="{{ route('admin.delete.country',$countrys->id) }}">
 ...
 <div class="modal fade text-left" id="addNewCountry" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('uk_management.store.country')}}" method="POST">
                @csrf
                <div class="col-12">
