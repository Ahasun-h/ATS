...
<head>
    @include('management.admin.partials._head')
</head>
<!-- END: Head-->
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-light navbar-shadow">
        @include('management.admin.partials._header-navbar')
    </nav>
    <!-- Nav -->
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        @include('management.admin.partials._sidebar')
    </div>
    <!-- END: Main Menu-->
    ...
    <footer class="footer footer-static footer-light">
        @include('management.admin.partials._footer')
    </footer>
    ...
    <!-- BEGIN: Vendor JS-->
    @include('management.admin.partials._footer-script')
    <!-- END: Vendor JS-->
