...
class CountryController extends Controller
{
    ...
    public function viewCountry(){
        ...
        return view('management.uk_management.layout.country.all_country',$data);
    }
    ...
    public function storeCountry(Request $request){
        ...
        return redirect()->route('uk_management.view.country')->with('Task Complete ', 'Country Name Add successfully');
    }
    ...
    public function deleteCountry($id){
        ...
        $country->delete();
        return redirect()->route('uk_management.view.country')->with('Task Complete ','Selected Country Deleted successfully');
    }
}
