...
class CityController extends Controller
{
    ...
    public function viewCity(){
        ...
        return view('management.admin.layout.city.all_city',$data);
    }
    ...
    public function storeCity(Request $request){
        ...
        return redirect()->route('admin.view.city')->with('Task Complete ', 'Country Name Add successfully');
    }
    ...
    public function deleteCity($id){
        $city = City::find($id);
        $city->delete();
        return redirect()->route('admin.view.city')->with('Task Complete ','Selected City Deleted successfully');
    }
